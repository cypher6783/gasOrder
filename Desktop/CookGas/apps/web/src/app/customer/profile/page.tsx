          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            ...
            <div className="space-y-3">
                {addresses.length === 0 ? (
                    ...
                    addresses.map((addr) => (
                        <div key={addr.id} className="p-3 border border-gray-100 rounded-lg flex justify-between items-start">
                            <div>
                                <p className="font-medium text-gray-800 text-sm">{addr.street}</p>
