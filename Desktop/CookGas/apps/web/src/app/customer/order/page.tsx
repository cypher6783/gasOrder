    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-8 transition-colors duration-300">
      <div className="container-custom">
        <div className="mb-6 flex items-center justify-between">
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Order Cooking Gas</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-4">
            <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-200">Available Vendors</h2>
            {products.length === 0 ? (
                <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 text-center text-gray-500 dark:text-gray-400">
                ...
                <div 
                    ...
                    className={`bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border cursor-pointer transition-all hover:shadow-md dark:hover:shadow-gray-900/50 ${
                ...
                >
                    <div className="flex justify-between items-center">
                        <div>
                            <h3 className="font-bold text-lg text-gray-900 dark:text-white">{product.vendor.businessName}</h3>
                        ...
                        <div className={`w-6 h-6 rounded-full border-2 flex items-center justify-center ${
                             selectedProduct?.id === product.id ? 'border-primary-600 dark:border-primary-500' : 'border-gray-300 dark:border-gray-600'
                        }`}>
                            {selectedProduct?.id === product.id && (
          ...
          <div className="lg:col-span-1">
            <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 sticky top-8">
                ...
                {!selectedProduct ? (
                    <p className="text-gray-500 dark:text-gray-400 text-sm">Select a vendor to proceed.</p>
                ) : (
                    <form onSubmit={handleOrder} className="space-y-6">
                        <div>
                            <p className="text-sm text-gray-500 dark:text-gray-400 mb-1">Selected Vendor</p>
                            <p className="font-medium text-gray-900 dark:text-white">{selectedProduct.vendor.businessName}</p>
                        </div>
                        ...
                        <div className="border-t border-gray-100 dark:border-gray-700 pt-4 space-y-2">
                            <div className="flex justify-between text-sm">
                                ...
                                <span className="font-medium dark:text-gray-200">₦{selectedProduct.price.toLocaleString()}</span>
                            </div>
